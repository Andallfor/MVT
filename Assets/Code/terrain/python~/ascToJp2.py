...
INPUT = "C:/Users/leozw/Downloads/rasters_SRTMGL1/output_SRTMGL1.asc"
OUTPUT_JP2 = "C:/Users/leozw/Downloads/rasters_SRTMGL1/data.jp2"
OUTPUT_METADATA = "C:/Users/leozw/Downloads/rasters_SRTMGL1/metadata.txt"
...
with open(INPUT, "r") as f:
    ...
    dataArr = np.ndarray(shape=(metadata['nrows'] - 1, metadata['ncols']), dtype=np.uint16)
    ...
    s1 = time.time()
    for count, row in enumerate(range(metadata["nrows"])):
        try:
            line = next(f).split()
        except:
            print("nrows do not match up!\n")
            metadata["nrows"] = count
            break
    ...
    glymur.Jp2k(OUTPUT_JP2, data=dataArr, cratios=[32, 16, 8, 4, 2, 1])
